...
class RegistrationController: UIViewController {
    ...
    @objc func handleRegistration(){
        ...
        AuthService.shared.registerUser(credentials: credentials) { error, ref in
            if let error = error {
                print("Error is in registration \n\(error.localizedDescription)")
                return
            }
    ...
    func configureUI(){
        ...
        alreadyHaveAccountButton.anchor(leading: view.leadingAnchor, bottom: view.safeAreaLayoutGuide.bottomAnchor, trailing: view.trailingAnchor, paddingLeading: 40, paddingTrailing: 40)
    }
}
